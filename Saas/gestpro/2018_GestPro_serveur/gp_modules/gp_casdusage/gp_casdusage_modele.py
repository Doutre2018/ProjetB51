...
class Modele():
    ...
    def insertScenarii(self, ligne, usager, machine ):
        self.BD.requeteInsertionPerso("INSERT INTO Scenarii(id_projet, id_casUsage,ligne,id_colonne) VALUES('" + str(self.numProjet) + "','" + str(ligne) + "','" + str(usager) + "','" + str(1) + "');")
        self.BD.requeteInsertionPerso("INSERT INTO Scenarii(id_projet, id_casUsage,ligne,id_colonne) VALUES('" + str(self.numProjet) + "','" + str(ligne) + "','" + str(machine) + "','" + str(2) + "');")
    ...
    def selectScenarii(self, ligne):
        ...
        self.casUsagers = self.BD.requeteSelection("SELECT ligne FROM CasUsage WHERE id_projet = '" + str(numProjet) + "' AND id_colonne = '" + str(idUsager) + "' ;")
        self.casMachines = self.BD.requeteSelection("SELECT ligne FROM CasUsage WHERE id_projet = '" + str(numProjet) + "' AND id_colonne = '" + str(idMachine) + "' ;")

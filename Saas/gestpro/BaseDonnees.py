...
class  BaseDonnees():
    ...
    def genererListeConst(self):
        listeConst = [
            ...
            ['AttributsCRC', 'fk_attributsCrc_classe', 'id_classe', 'Cartes', 'id'],
            ['Cartes', 'fk_cartes_heritage', 'id_carte_heritage', 'Cartes', 'id'],
            ['Cartes', 'fk_cartes_responsable', 'idResponsable', 'Utilisateur', 'id'],
            ['Cartes', 'fk_cartes_projet', 'id_projet', 'Projet', 'id'],
            ['Objet_Maquette', 'fk_objetMaquette_position', 'id_position', 'Position', 'id'],
            ['Objet_Maquette', 'fk_objetMaquette_type', 'id_type', 'TypeForme', 'id'],
            ['TachesTerlow', 'fk_tachesTerlow_projet', 'id_projet', 'Projet', 'id'],
            ['TachesTerlow', 'fk_tachesTerlow_colonnes', 'id_colonne_terlow', 'Colonnes_Terlow', 'id'],
            ['Objet_Texte', 'fk_objetTexte_pos', 'id_position', 'Position', 'id'],
            ['Tache_Sprint', 'fk_tachesSprint_sprint', 'id_sprint', 'Sprint', 'id'],
            ['Sprint', 'fk_sprint_projet', 'id_projet', 'Projet', 'id'],
            ]
        return listeConst
